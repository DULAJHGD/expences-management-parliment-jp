...
function Evidance() {
  ...
  // Handle file upload and update the evidence field
  // const handleFileUpload = (index, file) => {
  //   const updatedRows = sortedRows.map((row, rowIndex) => {
  //     if (rowIndex === index) {
  //       return { ...row, evidence: file };
  //     }
  //     return row;
  //   });
  //   setSortedRows(updatedRows);
  ...
  // Handle removing the uploaded evidence
  // const handleRemoveEvidence = (index) => {
  //   const updatedRows = sortedRows.map((row, rowIndex) => {
  //     if (rowIndex === index) {
  //       return { ...row, evidence: null }; // Remove evidence
  //     }
  //     return row;
  //   });
  //   setSortedRows(updatedRows);
